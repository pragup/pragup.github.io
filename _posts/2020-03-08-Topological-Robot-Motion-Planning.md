...
identity map ${id}_{X}$ on $X$ i.e $r \simeq $ ${id}_{X}$.

<!--   $r \simeq {id}_{X}$ Deformation retraction implies homotopy equivalence between topological space $X \simeq Y$. Some examples are shown in 
